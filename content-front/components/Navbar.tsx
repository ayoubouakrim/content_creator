...
export default function Navbar() {
    ...
    const navItems = [
        ...
        {
            id: "analytics", label: "Analytics", href: "/content/seo-report",
        ...
        {
            id: "trends", label: "Trends", href: "/content/hashtags",
    ...
    const isActive = (itemId: string) => {
        ...
        if (itemId === "analytics") return pathname === "/content/seo-report";
        if (itemId === "trends") return pathname === "/content/hashtags";
        return false;
    };
